    ...
    <div className={ css.ReleaseInfo }>
      <ul className="dashed">
        <li>
          ...
          With this release, we add support for Camunda Cloud 1.3. <br />
          In addition, you can now copy and paste contents between diagrams without loosing the original IDs.
        </li>
        <li>
          <h4>Support for AssignmentDefinition in Camunda Cloud UserTasks</h4>
          You can now assign Camunda Cloud UsersTasks using the 'assignee' or 'candidateGroups' properties via the properties panel.
          Both fields can either include a static value or a Feel expression.
        </li>
      </ul>
